...
class SavgolPlatform extends FlutterRustBridgeBase<SavgolWire> {
  SavgolPlatform(ffi.DynamicLibrary dylib) : super(SavgolWire(dylib));
...
class SavgolWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  void wire_savgol_filter(
    int port_,
    ffi.Pointer<wire_float_64_list> x,
    int window_length,
    int poly_order,
    int derivative,
  ) {
    return _wire_savgol_filter(
      port_,
      x,
      window_length,
      poly_order,
